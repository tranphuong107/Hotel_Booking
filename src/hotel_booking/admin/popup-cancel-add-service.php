            ...
            <div class="content-popup ">
                <div class="confirm rounded">
                    ...
                    <div class="text-end px-4 pt-3 pb-0" style="margin-bottom:-6%">
                        <button href="#" class="btn-close" style="margin-top:-90px padding-top:6%" onclick="closeForm5()" on data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    </div>
                    <div class="row pt-3">
                    ...
                    <div class="row p-4 justify-content-end pb-4">
                        <div class="col-3 text-center" >
                           <?php echo'<a href ="service-show.php" style="background-color:#e17055; width: 90px; color: white;" class="py-2 btn btn-primary fs-6 border-0">Có</a>'?>
                           <!-- <input class="btn text-white px-3 fs-6 " value="Có" type="submit" style="width: 90px; background-color:#e17055;">-->
                        </div>
                        <div class="col-3" >
                            <input class="btn text-white  px-3 fs-6 " value="Không" type="submit" style="width: 90px; background-color: #6ab04c;"  onclick="closeForm5()" >
                        </div>
                    </div>
