                ...
                <div class="confirm rounded">
                    ...
                    <div class="row p-4 justify-content-end pb-4">
                        <div class="col-3 text-center" >
                           <?php echo'<a href ="cancel-order-ser.php?id='.$row['ordser_id'].'" style="background-color:#e17055; width: 90px; color: white;" class="py-2 btn btn-primary fs-6 border-0">Có</a>'?>
