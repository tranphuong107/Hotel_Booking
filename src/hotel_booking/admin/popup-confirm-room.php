            ...
            <div class="content-popup ">
                <div class="confirm rounded">
                    <div class="row ">
                        ...
                        <i class="far fa-question-circle fa-3x ps-4 pt-4 fs-1" style ="width: 500px; height:300px;color: #6ab04c;"></i>
                        </div>
                    <!--<i class="far fa-times-circle fa-3x text-center pt-4 fs-1" style ="width: 500px; heigh:300px;color: #e17055;"></i>-->
                        <div class="col">
                        <p class="text-start  fs-6 " style ="padding-top:6% ; " >Bạn có chắc chắn thực hiện Xác nhận đơn không ? Thao tác sau khi thực hiện sẽ không thể thay đổi.</p>
                        </div>
