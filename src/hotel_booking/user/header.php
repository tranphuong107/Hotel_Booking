          ...
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav mx-4">
                ...
                <a href="index.php" class = "nav-link fs-6 fw-bold text-decoration-none mx-2" style = "color:black">Đơn hàng</a>
                <a href="login.php" class = "nav-link fs-6 fw-bold text-decoration-none mx-2" style = "color:black">Đăng nhập</a>
                <a class="nav-link fw-bold text-decoration-none fs-6 mx-2" href="register.php" style = "color:black" tabindex="-1" >Đăng ký</a>
              </div>
            </div>
        </div>
      </div>
