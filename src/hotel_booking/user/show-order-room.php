<style>
 ...
 <div class="content-popup" id="myForm2">
     <div class = "form-popup">
        ...
        <div class = "title">
            <h3 class = "titlee"><center>ĐẶT PHÒNG</center></h3>
        </div> 
 ...
 <?php       
    ...
    ?>  
                   ...
                   <?php echo '<option value="'.$row['room_ID'].'">'.$row['room_type'].'</option>';}}}else {
            echo 'Có lỗi';
        }?>
                </select>
            </div>
        ...
        <div class = "vao">
            ...
            <div class = "pt-2" style = "">
                ...
                <div class = "pt-1 pb-0" style = "padding-right:50px;">(Tháng/Ngày/Năm)</div>
            </div></div>
        </div>
        <div class = "vao pt-0">
            ...
            <div class = "pt-2" style = "">
                <input type="date" class = "rounded pb-1 pt-1 ps-1" style = "background-color:#c49872b3;border:none;color:#2e1c09;width:263px;"> 
                <div style = "text-align:right">
                <div class = "pt-1 pb-1" style = "padding-right:50px;">(Tháng/Ngày/Năm)</div>
             </div>
            </div>
        </div>
        <div class = "button" >
            <a href="#" onclick = "runAlert()" class = "btn fw-bold m-0 mt-3" style = "font-size: 15px;">Đặt phòng</a>
        </div>
    </div>
</div>
